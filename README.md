...
- Finished sequences can be deleted from the dashboard (a running one must be stopped first); simulated cards are amber, real-order cards are red, so a mixed dashboard stays readable.
